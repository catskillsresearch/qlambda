...
This dependency-light module supplies the physical state used at the
typed language's quantum runtime boundary.  It is independent of the
discarded CEK/channel-tree and choice developments.
-/
